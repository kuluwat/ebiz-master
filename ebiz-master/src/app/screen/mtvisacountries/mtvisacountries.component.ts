...
export class MtvisacountriesComponent implements OnInit {
  ...
  onloadX() {
    ...
    const onSuccess = (data : any): void => {
      ...
      // this.ArrData['list_status'].forEach(function (e : any) {
      //   if (typeof e === 'object') {
      //     var re;
      //     if (e.status == '1') {
      //       re = true;
  ...
  openModalx(template: TemplateRef<any>, zone_new : any, county_new : any) {
  ...
  Chang_Status(id : any, textX : any, txbtn : any) {
    ...
    //var txbtn = "Delete";
    this.swl.swal_confirm_changes('').then((val) => {
      if (val.isConfirmed) {
  ...
  Status_Edit(template: TemplateRef<any>, id : any)  {
  ...
  filter_country(arr : any, model : any) {
    console.log(arr);
    console.log(model);
    var re;
    if (model != '') {
      re = arr.filter((word : any) => word.main_id == model);
    } else {
      re = [];
    }
  ...
  add_zone_to_country(id_zone : any, id_coun : any) {
    debugger;
    if (id_zone == 'undefined') {
      return;
    } else {
      try {
        var arr_objectx = this.visa_docountries.filter((word : any) => word.continent_id == id_zone && word.country_id == '');
        var arr_visa_docountries = this.visa_docountries;
        console.log('Before add new function');
        console.log(arr_visa_docountries);
        arr_objectx.forEach((e : any) => {
        ...
        var arr_Imgx = this.img_list.filter((word: any ) => word.id_level_1 == id_zone && word.id_level_2 == '');
        var img_list_arr = this.img_list;
        if (arr_Imgx.length > 0) {
          arr_Imgx.forEach((el : any) => {
  ...
  TestChang(event : any, zone: any, country: any) {
    console.log(event);
    // if (!country) {
    //   return;
    // }
    ...
    // if (zone == [] || zone == '') {
    //   if ('value' in event) {
    //     this.zone_new = this.zone_select.filter((word : any) => word.id == event.value.main_id);
    ...
    if (typeof country === 'object') {
      ...
      //   var check_length = this.visa_docountries.filter((word : any) => word.country_id == country.id);
  ...
  County_chang(zone : any) {
    ...
    // } else {
    //   try {
    //     var re = this.country_select.filter((word : any) => word.main_id == zone.id);
    //     //console.log();
  ...
  filter_country_new(arr : any, model: any) {
    //console.log(model.name);
    var re;
    try {
      if (model != '') {
        re = arr.filter((word: any) => word.main_id == model.name);
      } else {
        re = [];
      }
    } catch (err) {
  ...
  checkbox(arr: any, zone_new: any, county_new: any) {
    // visa_docountries
    ...
    if (typeof county_new === 'object') {
      ...
      //     (word : any) => word.country_id == county_new.id && word.continent_id == zone_new.id
      //   );
      // } else {
      //   re = this.visa_docountries.filter((word : any) => word.continent_id == zone_new.id && word.country_id == '');
      // }
    } else {
    ...
    re = re.filter((word : any) => word.action_type != 'delete');
 ...
 */
  ...
  UpdateChecked({ ev, item } : any) {
    const { checked } = ev.target;
    item['ShowStatus'] = checked;
    // console.log(checked, item, this.masterDoc_Selection);
  }
  setCheckBoxDoc(event : any, idx : any, zone_new: any, county_new : any, masterDoc : any) {
    ...
    var re;
    if (typeof county_new === 'object') {
      re = this.visa_docountries.filter((word : any) => word.continent_id == zone_new.id && word.country_id == county_new_id);
    } else {
      re = this.visa_docountries.filter((word : any) => word.continent_id == zone_new.id && word.country_id == '');
    }

    var check_length = re.filter((word : any) => word.visa_doc_id == idx);

    if (check_length.length > 0) {
      this.visa_docountries.forEach(function (e : any) {
      ...
      var img_del = this.visa_docountries.filter(
        (word : any) => word.continent_id == zone_new.id && word.country_id == county_new_id
      );
      var img_del_length = img_del.filter((word : any) => word.action_type != 'delete');
      if (img_del_length.length <= 0) {
        this.img_list.forEach(function (e : any) {
  ...
  tableRespont(arr : any, zone_new : any, county_new : any) {
    try {
      var xx = county_new;
      if (zone_new.id == 'undefined' || zone_new.id == '') {
        ...
        var count = 0;
        re.forEach(function (e : any) {
          var datax = arr.filter((word: any) => word.id == e.visa_doc_id);
  ...
  check_length(masterDoc : any, zone_new: any, county_new: any) {
    var outEx;
    try {
  ...
  check_boxChang(event: any, idx: any, zone_new: any, county_new: any, masterDoc: any) {
    debugger;
  ...
  addrow(id: any, zone_new: any, county_new: any ) {
  ...
  id_uploadFile : any;
  id_uploadFile2 : any;
  onFileSelect(event: any, id: any, id2: any) {
    debugger;
  ...
  deleterow_img(id: any, zone : any, county: any, img_list: any) {
    console.log(this.img_list);
  ...
  imgArr(zone: any, country: any, arr: any) {
    // debugger;
    arr = this.img_list;
    var re = arr;
    var c_data, z_data;
    ...
    if (zone.id == 'undefined' || zone.id == '') {
      ...
      if (typeof country === 'object') {
        ...
        if (country.id == 'undefined' || country.id == '' || country.length <= 0) {
          re = arr.filter((word : any) => word.id_level_1 == zone.id && word.id_level_2 == '');
        } else {
          re = arr.filter((word : any) => word.id_level_1 == zone.id && word.id_level_2 == county_new_id);
        }
      } else {
        if (country == 'undefined' || country == '' || country.length <= 0) {
          ...
          re = arr.filter((word : any) => word.id_level_1 == zone.id && word.id_level_2 == country.id);
          /* console.log(re); */
        }
      }
