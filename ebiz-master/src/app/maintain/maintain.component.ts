...
import { didCheckTokenDied, forceToPageLoginWeb } from '../function/globalfunction.component';
...
export class MaintainComponent implements OnInit {
  ...
  constructor(
    ...
    didCheckTokenDied(ws,this.profile.username,this.profile.images, this.profile.user_admin,authenHttp,router);
  }
