...
export class EbizhomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  mockImg = true;
  imgPath_1: string = "assets/imgs/1500500.png";
  imgPath_2: string = "assets/imgs/400300.png";
  // imgPath_3: string = "assets/imgs/1500300.png";
  imgPath_3_1: string = "assets/imgs/400300.png";
  url_banner_1: string = "";
  imgPath_3_2: string = "assets/imgs/400300.png";
  url_banner_2: string = "";
  imgPath_3_3: string = "assets/imgs/400300.png";
  url_banner_3: string = "";
  imgPath_4: string = "assets/imgs/460300.png";
  selected = 'date';
  ...
  dateFrom: | undefined;
  dateTo : | undefined;
  training_dateFrom: | undefined;
  training_dateTo: | undefined;
  isAdmin: boolean = false;
  htmlContent = '';
  imageSource;
  lbInputFile: string = "Choose file";
  fileUploadTo: any = null;
  textPopupUpload: string = "";
  typeUploadTo: string = "";
  progressbar: boolean = false;
  textboxPopup: boolean = false;
  textWelcome: string = "";
  textWelDesc: string = "";
  textWelcome_popup: string = "";
  textWelDesc_popup: string = "";
  txtBanner: string = "";
  bannerUrl: boolean = false;
  isLoading: boolean = false;
  isFirstLoading: boolean = false;
  Traveling_objective: string = "";
  textBoxGetInTouch: boolean = false;
  textGetInTouchTitle: string = "";
  textGetInTouchEmail: string = "";
  textGetInTouchCallUs: string = "";
  textGetInTouchTitle_popup: string = "";
  textGetInTouchEmail_popup: string = "";
  textGetInTouchCallUs_popup: string = "";
  urlCarservice = "https://carservice.thaioilgroup.com/";
  urlIpettyCash = "http://i-link/ess1/Tcp.aspx";//"http://i-link/zess/ess3/petty_cash/PC_Portal.aspx";
  listContact: any = [];
  listMasterData: any = [];
  ...
  training_destination: string = "";
  training_myControl = new FormControl();
  training_filteredOptions: Observable<string[]> | undefined;

  requestType: string = "oversea";
  destinationObj: any = {};

  training_requestType: string = "overseatraining";
  training_destinationObj: any = {};
  ...
  url_approval: string = "";
  url_employee_payment: string = "";
  url_others: string = "";
  url_transportation: string = "";
  ...
  selectedOption(event, type: string) {
    ...
    if (type === "business") {
      ...
      this.training_destinationObj = event.option.value;
      this.training_destination = event.option.value.name;
    }
  }
  ...
  private _filter(value: any): any[] {
    ...
    return this.country_list.filter(option => option.name.toLowerCase().includes(filterValue.toLowerCase()));
  }
  private _filter_training(value: any): any[] {
    const filterValue = value;//value.toLowerCase();

    return this.country_list_training.filter(option => option.name.toLowerCase().includes(filterValue.toLowerCase()));
  }
  ...
  onload() {
    ...
    const onSuccess = (data) => {
      ...
      this.imgPath_1 = data.img_list[ 0 ].img_header.replace(" ", "%20");
      this.imgPath_2 = data.img_list[ 0 ].img_personal_profile.replace(" ", "%20");

      this.imgPath_3_1 = data.img_list[ 0 ].img_banner_1.replace(" ", "%20");
      this.url_banner_1 = data.img_list[ 0 ].url_banner_1;
      this.imgPath_3_2 = data.img_list[ 0 ].img_banner_2.replace(" ", "%20");
      this.url_banner_2 = data.img_list[ 0 ].url_banner_2;
      this.imgPath_3_3 = data.img_list[ 0 ].img_banner_3.replace(" ", "%20");
      this.url_banner_3 = data.img_list[ 0 ].url_banner_3;
      this.imgPath_4 = data.img_list[ 0 ].img_practice_areas.replace(" ", "%20");

      this.textWelcome = data.text_title;
      this.textWelDesc = data.text_desc;
      this.textWelcome_popup = data.text_title;
      this.textWelDesc_popup = data.text_desc;
      ...
      this.textGetInTouchTitle_popup = data.text_contact_title;
      this.textGetInTouchEmail_popup = data.text_contact_email;
      this.textGetInTouchCallUs_popup = data.text_contact_tel;

      this.url_approval = data.practice_areas[ 0 ].url_approval;
      this.url_employee_payment = data.practice_areas[ 0 ].url_employee_payment;
      this.url_others = data.practice_areas[ 0 ].url_others;
      this.url_transportation = data.practice_areas[ 0 ].url_transportation;
      ...
      const onSuccess2 = (data) => {
        ...
        this.training_filteredOptions = this.training_myControl.valueChanges
          .pipe(
            startWith(''),
  ...
  changeRequestType(event) {
    ...
    //debugger;
    if (event === 'oversea') {
      this.country_list = this.listMasterData.master_country;
    }
    else if (event === 'local') {

      this.country_list = this.listMasterData.master_province;
    }
    else if (event === 'overseatraining') {
      this.country_list_training = this.listMasterData.master_country;
    }
    else if (event === 'localtraining') {

      this.country_list_training = this.listMasterData.master_province;
    }
    else {
      //this.country_list = [];
    }
  ...
  getDateformat(dateString, types) {

    let datesplit = dateString.split('/');
    var dateObject = new Date(datesplit[ 1 ] + '/' + datesplit[ 0 ] + '/' + datesplit[ 2 ]);

    let retValue = '';
    retValue = types === 'DM' ? this.datepipe.transform(dateObject, 'dd MMM') : types === "YY" ? this.datepipe.transform(dateObject, 'yy') : '';
  ...
  getUrl() {
    if (this.mockImg) {
      this.imgPath_1 = this.data.img_list[ 0 ].img_header; //"assets/imgs/w0002.jpg";
      this.imgPath_2 = this.data.img_list[ 0 ].img_personal_profile;//"assets/imgs/w400300_4.jpg";
      //this.imgPath_3 = "assets/imgs/w1500300_2.jpg";
      this.imgPath_3_1 = this.data.img_list[ 0 ].img_banner_1;
      this.url_banner_1 = this.data.img_list[ 0 ].url_banner_1;
      this.imgPath_3_2 = this.data.img_list[ 0 ].img_banner_2;
      this.url_banner_2 = this.data.img_list[ 0 ].url_banner_2;
      this.imgPath_3_3 = "";//this.data.img_list[0].img_banner_3;
      this.url_banner_3 = "";
      this.imgPath_4 = this.data.img_list[ 0 ].img_practice_areas;//"assets/imgs/w460300_1.png";
    }
  ...
  selectionChanges(type: string, event) {
    console.log(event);
    //alert(type);
  ...
  saveText(types) {
    ...
    if (this.typeForSave === "title") {
      ...
      this._dataSource.text_title = this.textWelcome_popup;
      this._dataSource.text_desc = this.textWelDesc_popup;

    }
    else if (this.typeForSave === "get_in_touch") {
      this._dataSource.action_change_imgname = "get_in_touch";
      this._dataSource.text_contact_title = this.textGetInTouchTitle_popup;
      this._dataSource.text_contact_email = this.textGetInTouchEmail_popup;
      this._dataSource.text_contact_tel = this.textGetInTouchCallUs_popup;
    }
    ...
    const onSuccess = (data) => {
      ...
      if (data.after_trip.opt1 == "true") {
        ...
        setTimeout(() => {
          ...
          this.imgPath_1 = data.img_list[ 0 ].img_header;
          this.imgPath_2 = data.img_list[ 0 ].img_personal_profile;

          this.imgPath_3_1 = data.img_list[ 0 ].img_banner_1;
          this.url_banner_1 = data.img_list[ 0 ].url_banner_1;
          this.imgPath_3_2 = data.img_list[ 0 ].img_banner_2;
          this.url_banner_2 = data.img_list[ 0 ].url_banner_2;
          this.imgPath_3_3 = data.img_list[ 0 ].img_banner_3;
          this.url_banner_3 = data.img_list[ 0 ].url_banner_3;
          this.imgPath_4 = data.img_list[ 0 ].img_practice_areas;
  ...
  goto_training_trip() {
    ////debugger;
    if (this.training_destination === "") {this.training_destinationObj = {};}
    console.log(this.training_requestType);
    console.log(this.training_destinationObj);
    let typeStr = "";
    let name = "";
    !this.ws.isEmpty(this.training_destinationObj) ? typeStr = this.training_destinationObj.id : typeStr = "";
    ...
    // if (this.training_dateFrom != undefined && this.training_dateFrom != null && this.training_dateFrom.length === 2) {
    //   dateF = new Date(this.training_dateFrom[ 0 ].setHours(20, 21, 22));
    //   dateT = new Date(this.training_dateFrom[ 1 ].setHours(20, 21, 22));
    // }
    // else {
    //   dateF = "";
    //   dateT = "";
    ...
    const navigationExtras: NavigationExtras = {
      ...
      queryParams: {
        ...
        dateFrom: dateF,
        dateTo: dateT,
        requestType: this.training_requestType
      },
      skipLocationChange: false,
      fragment: 'top'
    };
    ...
    // Navigate to component B
    this.router.navigate([ 'main/request/create/' + this.training_requestType + '/i' ], {
      state: {requestDetails: navigationExtras}
    });
  ...
  sendMail() {
    ...
    const onSuccess = (data) => {
      ...
      if (data.after_trip.opt1 == "true") {
        ...
        this.alerts.toastr_sucess(data.after_trip.opt2.status);
        this.isLoading = false;
      }
      else {
        this.isLoading = false;
  ...
  navigateWithArray(requestType): void {
    //debugger;
