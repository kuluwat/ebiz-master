...
import { PartIiService } from 'src/app/http/part-ii/part-ii.service';
...
export class RequestPartIIComponent implements OnInit {
  ...
  handleActionApproverShowTextToEdit(action: String, index) {
    debugger;
    this.currentIndexEditApprover = []
    if (action == "edit") {
      //
